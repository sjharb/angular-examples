...
@Component({
  ...
  imports: [MatIconModule, CommonModule, MatSidenavModule, MatCheckboxModule, FormsModule, MatButtonModule, JsonRequest, MatInputModule, MatFormFieldModule, MatSelect, MatOption, ThemeController],
...
export class AppSideNav {
  ...
  sideNavOptionsButtonText: string = 'Close Options';
  mainOptionsButtonText: string = 'Options';
  mainOptionsButtonIconName: string = 'more';
  //currentTheme: any;
  ...
  sideNavOpened() {
    ...
    this.mainOptionsButtonIconName = '';
    this.isNavButtonDisabled = true;
  }

  sideNavClosed() {
    //this.mainOptionsButtonText = '<<'
    this.mainOptionsButtonIconName = 'more';
